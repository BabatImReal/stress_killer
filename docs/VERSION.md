...
**Current version: 0.2.1** (kept in sync with `package.json`)
...
|---------|------------|-----------------|---------|
| 0.2.1 | 2026-07-18 | Phase 1 | Fixes: stumble root-motion slide (hips X/Z locked, verified <3 cm drift), idle slowed to stop the "dancing". |
